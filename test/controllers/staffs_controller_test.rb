...
class StaffsControllerTest < ActionController::TestCase
  ...
  test "should create staff" do
    assert_difference('Staff.count') do
      post :create, staff: { isactive: @staff.isactive, isadmin: @staff.isadmin, issuper: @staff.issuper }
    end
  ...
  test "should update staff" do
    patch :update, id: @staff, staff: { isactive: @staff.isactive, isadmin: @staff.isadmin, issuper: @staff.issuper }
    assert_redirected_to staff_path(assigns(:staff))
  end
