...
(function($) {
  ...
  $("document").ready(function(){
    $("#reg-remember").click(function(){
      ...
      if(!checked){
        $("#reg-remember").css('color', color[1])
        $("#reg-remember").html('Your Session will be remembered for two weeks.<br /><i>(Click again to dismiss)</i>')
      } else{
        $("#reg-remember").text("Remember me")
